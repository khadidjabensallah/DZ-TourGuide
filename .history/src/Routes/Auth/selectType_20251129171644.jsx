      ...
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-lg">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex-1 py-5 px-6 rounded-lg font-semibold text-base transition-all duration-200 flex items-center justify-center gap-3 bg-gray-50 border-2 border-transparent text-gray-600 hover:bg-orange-_à"
          >
