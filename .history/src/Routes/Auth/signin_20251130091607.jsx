  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Back Button */}
        <button
          className="flex items-center text-gray-700 mb-6 hover:text-gray-900 transition-colors autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)]"
          onClick={() => navigate("/")}
        >
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-600">
              ...
              <button
                ...
                className="text-orange-500 font-semibold hover:text-orange-600 transition-colors autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)]"
              >
                Register
              </button>
            </p>
