      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-6">
          <div className="flex justify-center mb-1">
            <img
              src={logo}
              alt="TGUIDA Logo"
              className="w-32 object-contain -my-8 -mt-9"
            />
          </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-lg 
                        focus:ring-2 focus:ring-orange-500 focus:outline-none autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)] ${
                          errors.firstName
                            ? "border-red-500"
                            : "border-gray-300"
                        }`}
            ...
            <div className="flex">
              <span
                className="inline-flex items-center px-3 rounded-l-lg border border-r-0 
                               border-gray-300 bg-gray-100 text-gray-700 autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)]"
              >
                +213
              </span>
              <input
          ...
          <button
            ...
            className="w-full bg-orange-500 py-2 text-white font-semibold rounded-xl 
                       hover:bg-orange-600 
